...
module rocket_CLINTClockSinkDomain(	// src/main/scala/prci/ClockDomain.scala:14:9
  ...
  input  [2:0]  auto_clint_in_a_bits_opcode,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
                auto_clint_in_a_bits_param,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input  [1:0]  auto_clint_in_a_bits_size,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input  [8:0]  auto_clint_in_a_bits_source,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input  [25:0] auto_clint_in_a_bits_address,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input  [7:0]  auto_clint_in_a_bits_mask,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input  [63:0] auto_clint_in_a_bits_data,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  input         auto_clint_in_a_bits_corrupt,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
                auto_clint_in_d_ready,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output        auto_clint_in_d_valid,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output [2:0]  auto_clint_in_d_bits_opcode,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output [1:0]  auto_clint_in_d_bits_size,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output [8:0]  auto_clint_in_d_bits_source,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output [63:0] auto_clint_in_d_bits_data,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  output        auto_int_in_clock_xing_out_sync_0,	// dependencies/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25
  ...
  wire [63:0] auto_clint_in_d_bits_data_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [8:0]  auto_clint_in_d_bits_source_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [1:0]  auto_clint_in_d_bits_size_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  ...
  wire [1:0]  auto_clint_in_a_bits_size_0 = auto_clint_in_a_bits_size;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [8:0]  auto_clint_in_a_bits_source_0 = auto_clint_in_a_bits_source;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [25:0] auto_clint_in_a_bits_address_0 = auto_clint_in_a_bits_address;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [7:0]  auto_clint_in_a_bits_mask_0 = auto_clint_in_a_bits_mask;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire [63:0] auto_clint_in_a_bits_data_0 = auto_clint_in_a_bits_data;	// src/main/scala/prci/ClockDomain.scala:14:9
  wire        auto_clint_in_a_bits_corrupt_0 = auto_clint_in_a_bits_corrupt;	// src/main/scala/prci/ClockDomain.scala:14:9
  ...
  wire        auto_int_in_clock_xing_out_sync_0_0 = intInClockXingOut_sync_0;	// dependencies/diplomacy/diplomacy/src/diplomacy/nodes/MixedNode.scala:543:17, src/main/scala/prci/ClockDomain.scala:14:9
  wire        intInClockXingIn_sync_1;	// dependencies/diplomacy/diplomacy/src/diplomacy/nodes/MixedNode.scala:552:17
  ...
  rocket_CLINT clint (	// src/main/scala/devices/tilelink/rocket_CLINT.scala:110:48
    ...
    .auto_in_a_valid        (auto_clint_in_a_valid_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_opcode  (auto_clint_in_a_bits_opcode_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_param   (auto_clint_in_a_bits_param_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_size    (auto_clint_in_a_bits_size_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_source  (auto_clint_in_a_bits_source_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_address (auto_clint_in_a_bits_address_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_mask    (auto_clint_in_a_bits_mask_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_data    (auto_clint_in_a_bits_data_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_a_bits_corrupt (auto_clint_in_a_bits_corrupt_0),	// src/main/scala/prci/ClockDomain.scala:14:9
    .auto_in_d_ready        (auto_clint_in_d_ready_0),	// src/main/scala/prci/ClockDomain.scala:14:9
  ...
  assign auto_clint_in_a_ready = auto_clint_in_a_ready_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_clint_in_d_valid = auto_clint_in_d_valid_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_clint_in_d_bits_opcode = auto_clint_in_d_bits_opcode_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_clint_in_d_bits_size = auto_clint_in_d_bits_size_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_clint_in_d_bits_source = auto_clint_in_d_bits_source_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_clint_in_d_bits_data = auto_clint_in_d_bits_data_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_int_in_clock_xing_out_sync_0 = auto_int_in_clock_xing_out_sync_0_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign auto_int_in_clock_xing_out_sync_1 = auto_int_in_clock_xing_out_sync_1_0;	// src/main/scala/prci/ClockDomain.scala:14:9
  assign clock = clockNodeIn_clock;	// dependencies/diplomacy/diplomacy/src/diplomacy/nodes/MixedNode.scala:552:17, src/main/scala/prci/ClockDomain.scala:14:9
  assign reset = clockNodeIn_reset;	// dependencies/diplomacy/diplomacy/src/diplomacy/nodes/MixedNode.scala:552:17, src/main/scala/prci/ClockDomain.scala:14:9
endmodule
