...
module rocket_AsyncResetRegVec_w1_i0(	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
  input  clock,	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
         reset,	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
         io_d,	// src/main/scala/util/rocket_AsyncResetReg.scala:59:14
  output io_q	// src/main/scala/util/rocket_AsyncResetReg.scala:59:14
);

  wire io_d_0 = io_d;	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
  wire io_en = 1'h1;	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
  reg  reg_0;	// src/main/scala/util/rocket_AsyncResetReg.scala:61:50
  wire io_q_0 = reg_0;	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7, :61:50
  always @(posedge clock or posedge reset) begin	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
    if (reset)	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
      reg_0 <= 1'h0;	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7, :61:50
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
    ...
    initial begin	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
        ...
        reg_0 = _RANDOM[/*Zero width*/ 1'b0][0];	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7, :61:50
      `endif // RANDOMIZE_REG_INIT
      if (reset)	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7
        reg_0 = 1'h0;	// src/main/scala/util/rocket_AsyncResetReg.scala:56:7, :61:50
    end // initial
